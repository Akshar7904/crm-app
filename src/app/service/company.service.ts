...
export class CompanyService {
  ...
  updateMyBranding$(data: { name?: string; tagline?: string; primaryColor?: string; theme?: string; email?: string; phone?: string; address?: string; employeeIdPrefix?: string }): Observable<any> {
